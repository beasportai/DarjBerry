  ...
  return (
    <section className="px-4 py-20 flex max-md:flex-col items-center md:px-28 md:py-32 sm:px-16 ">
      <motion.div className="max-md:text-center">
        ...
        >
          Spread <span className="text-green-800"> Berries</span> in your life.
        </motion.h1>
        <motion.p
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        >
          Premium quality blueberries for your health and taste
        </motion.p>
        <Link href="/#plants">
          <motion.button
            initial={{ y: 20, opacity: 0 }}
        ...
        <div className="mt-8 flex  items-center  max-md:justify-center gap-24">
          <div>
            ...
            <span className="text-gray-700 text-sm">Happy Customers</span>
          </div>
          <div>
              <p className="text-green-800 text-3xl md:text-4xl">10000+</p>
            <span className="text-gray-700 text-sm">Delivered Orders</span>
          </div>
        </div>
      </motion.div>
