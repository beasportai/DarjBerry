      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-3 lg:row-span-2 order-1">
              <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl p-8 text-white shadow-2xl h-full">
                ...
                <p className="text-purple-100 leading-relaxed text-lg">
                  <a
                    href="https://protocol.bryanjohnson.com/"
                    target="_blank"
                  ...
                  includes blueberries in his daily "Nutty Pudding" and
                  Blueberry Nut Mix - evidence-based nutrition for biological
                  age reversal.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 grid grid-cols-2 gap-4 lg:gap-6 order-3 lg:order-2">
              <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-purple-100">
                <a
                  href="https://www.healthline.com/nutrition/10-proven-benefits-of-blueberries"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block hover:scale-105 transition-transform duration-200"
                >
                  <div className="text-4xl font-bold text-purple-600 mb-2 hover:text-purple-700">
                    10x
                  </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-green-100">
                <a
                  href="https://www.bigbasket.com/pd/30009286/fresho-blueberry-125-g/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block hover:scale-105 transition-transform duration-200"
                >
                  <div className="text-3xl font-bold text-green-600 mb-2 hover:text-green-700">
                    ₹500-1200
                  </div>
                  <div className="text-gray-600 font-medium text-sm">
                    Premium price
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-blue-100">
                <a
                  href="https://www.imarcgroup.com/india-exotic-vegetables-market"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block hover:scale-105 transition-transform duration-200"
                >
                  <div className="text-4xl font-bold text-blue-600 mb-2 hover:text-blue-700">
                    12.3%
                  </div>
                  <div className="text-gray-600 font-medium text-sm">
                    CAGR growth
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-purple-100">
                <a
                  ...
                  className="block hover:scale-105 transition-transform duration-200"
                >
                  <div className="text-3xl font-bold text-purple-600 mb-2 hover:text-purple-700">
                    70gm
                  </div>
                  <div className="text-gray-600 font-medium text-sm">
                    Blueberries in daily diet
                  </div>
                  <div className="text-xs text-gray-500 mt-1">
                    Blueprint Protocol for longevity
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 lg:row-span-1 order-4 lg:order-3">
              <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl h-full">
                ...
                <p className="text-blue-100 leading-relaxed text-lg mb-6">
                  <a
                    href="https://www.alzdiscovery.org/cognitive-vitality/ratings/blueberries"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  blueberries improve memory formation within hours and
                  processing speed in 12 weeks. Superior cognitive benefits
                  compared to almonds (161.6k tons consumed in India annually).
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/20 rounded-2xl p-4">
                    ...
                    <p className="text-xs text-blue-100">
                      <a
                        href="https://nutritionfacts.org/blog/one-daily-cup-of-blueberries-found-to-improve-cognition/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-white underline hover:text-blue-200"
                      >
            ...
            <div className="lg:col-span-3 lg:row-span-1 order-5 lg:order-4">
              <div className="bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl p-8 text-white shadow-2xl h-full">
                ...
                <p className="text-green-100 leading-relaxed text-lg mb-6">
                  Blueberries used in{" "}
                  <a
                    href="https://dontwastethecrumbs.com/cheesecake-blueberry-smoothie/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white underline hover:text-green-200"
                  >
                    cheesecakes & smoothies
                  </a>
                  , premium muesli, and{" "}
                  <a
                    href="https://pmc.ncbi.nlm.nih.gov/articles/PMC10295438/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white underline hover:text-green-200"
                  >
                  ...
                  .{" "}
                  <a
                    href="https://www.news-medical.net/news/20230614/Study-reveals-impressive-skin-benefits-of-blueberries.aspx"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white underline hover:text-green-200"
                  >
                  ...
                  show UV protection and anti-aging benefits.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/20 rounded-2xl p-4">
                    <p className="text-sm font-semibold mb-2">
                    ...
                    <p className="text-xs text-green-100">
                      Premium desserts, smoothies, luxury muesli blends
                    </p>
                  </div>
                  <div className="bg-white/20 rounded-2xl p-4">
                    ...
                    <p className="text-xs text-green-100">
                      <a
                        href="https://www.healthline.com/nutrition/blueberry-benefits-for-skin"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-white underline hover:text-green-200"
                      >
            ...
            <div className="lg:col-span-3 order-2 lg:order-5">
              <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-purple-100 h-full">
                <a
                  href="https://pmc.ncbi.nlm.nih.gov/articles/PMC7442370/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block hover:scale-105 transition-transform duration-200"
                >
                  <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center hover:text-purple-700">
                    <span className="text-2xl mr-3">🧬</span>
                    Cellular Optimization
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    Anthocyanins research shows blueberries activate longevity pathways and protect DNA
                    from oxidative damage.
                  </p>
                  <div className="mt-3 p-3 bg-purple-50 rounded-lg">
                    <p className="text-xs text-purple-800 font-medium">
                      📊 13,427 total antioxidants per cup (blueberries)
                    </p>
                  </div>
                </a>
              </div>
