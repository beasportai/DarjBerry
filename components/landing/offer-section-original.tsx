...
export const OfferSection: React.FC<OfferSectionProps> = ({
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-slate-900 via-green-900 to-emerald-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-white via-green-100 to-emerald-200 bg-clip-text text-transparent leading-tight">
            ...
            <CardHeader className="bg-gradient-to-br from-emerald-600 via-green-600 to-emerald-700 text-white p-10 relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                    <div className="text-3xl font-bold text-yellow-200">{dynamicPaybackPeriod.toFixed(1)}</div>
