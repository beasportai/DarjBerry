...
export default function LandingPage() {
  const [selectedPlan, setSelectedPlan] = useState<"lumpsum3L" | "dailySIP">(
    "dailySIP"
  );
  const [subscriptionTier, setSubscriptionTier] = useState<"1year" | "2year">(
    "1year"
  );
...
💰 Investment Interest: ${
      selectedPlan === "dailySIP"
        ? "₹9,999 Daily SIP (90 plants/month)"
        : "Land + Blueberry Package (₹65L/0.5 acre)"
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-blue-100">
        ...
        <div className="relative container mx-auto px-4 py-16 text-center">
          <div className="max-w-4xl mx-auto">
            <Badge className="mb-4 bg-green-100 text-green-800 px-4 py-2 text-sm">
              🏔️ Darjeeling Blueberry Farms • Tax-Free Income • Capital
              Protected
            </Badge>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent leading-tight">
              Grow Berries on Your Land
              <br />
              or in the Himalayas
            </h1>

            <p className="text-lg sm:text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed px-4">
              <strong>Earn Passive Tax-Free Income</strong>
              <br />
              Be part of India's Amul for Berries 🫐
              <br />
              <span className="text-base sm:text-lg text-green-600 font-semibold">
                We take care of setup, growing, selling • Capital protected
                business
              </span>
            </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 md:mb-12 px-4">
          5 Reasons to Join Darjberry Today
        </h2>
          ...
          <Card className="border-2 hover:border-green-300 transition-colors md:col-span-2 lg:col-span-3">
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">
                Each acre (2500 bushes) generates ₹37.5 lakh annually from Year
                3 (7500kg × ₹500/kg). Far superior to traditional crops.
              </p>
          ...
          {[
            {
              ...
              description:
                "Your investment secures physical plants and infrastructure. Multi-State Cooperative structure ensures legal protection.",
            },
            {
              icon: <Leaf className="h-8 w-8 text-green-500" />,
              title: "Tax-Free Agricultural Income",
              description:
                "Section 10(1) exemption means zero tax on agricultural income. Additional Section 80P benefits for cooperative members.",
            },
            {
              icon: <Users className="h-8 w-8 text-purple-600" />,
              title: "Complete Setup & Management",
              description:
                "We handle polyhouse setup, irrigation, soil prep, planting, maintenance, harvesting, and selling. You just earn.",
            },
            {
              icon: <Clock className="h-8 w-8 text-orange-600" />,
              title: "Build Retirement Home from Revenue",
              description:
                "Farm revenue over 5-7 years can fund your dream retirement home on the same land. Live where you grow!",
            },
          ].map((benefit, index) => (
            <Card
              key={index}
            ...
            {[
              {
                ...
                answer:
                  "Comprehensive crop insurance covers weather risks. Polyhouse protection + diversified locations across Darjeeling reduce risk to near zero.",
              },
              {
                concern: '"How do I know you\'ll actually grow berries?"',
                answer:
                  "GPS-mapped plot allocation with real coordinates. Live farm visits included. IoT monitoring sends real-time updates to your phone.",
              },
              {
                concern: '"₹3 lakh is too much upfront investment."',
                answer:
                  "Start with ₹10,000 daily SIP! Gradual investment builds your berry empire. No pressure, completely flexible scaling.",
              },
              {
                concern: '"What if market prices crash?"',
                answer:
                  "Bryan Johnson effect + health trends ensure premium demand. Export markets + processing into jams/juices provide price stability.",
              },
            ].map((item, index) => (
      ...
      <section className="container mx-auto px-4 py-16 relative">
        ...
        <div className="relative">
          <h2 className="text-4xl font-bold text-center mb-4">
            Blueberry Farming Success Stories
          </h2>
          <p className="text-center text-gray-600 mb-12">
            Real success stories from established blueberry farmers across India
          </p>
            ...
            {[
              {
                ...
                rating: 5,
                review:
                  "Growing blueberries under high tunnels yields more fruit and extends harvest to 4-5 months. We're now producing 135 tonnes annually on 20 acres, supplying Swiggy, Zepto, Star Bazaar, and Reliance Retail.",
                source: "The Better India, 2024",
                sourceUrl:
                  "https://thebetterindia.com/345037/growing-blueberries-raspberries-in-india-lawyer-quits-start-farm2fam-low-cost-tunnel-method/",
              },
              {
                ...
                rating: 5,
                review:
                  "Blueberry imports into India grew from almost zero in 2009 to 1,900 tonnes in 2020. Well-managed farms achieve ₹2-10 lakhs profit per acre annually with berries fetching ₹1000/kg.",
                source: "Asia Farming, 2024",
                sourceUrl:
                  "https://www.asiafarming.com/how-to-start-blueberry-farming-in-india-varieties-yield-cost-and-profit-per-acre",
              },
              {
                ...
                rating: 5,
                review:
                  "Berry imports surged 148% to 870 tonnes in 2022. Each acre with 3000 plants producing 2kg per plant generates substantial profits at current market rates of ₹1000/kg.",
              ...
              <Card key={index} className="border-2 border-green-100">
                ...
                <CardContent>
                  ...
                  >
                    <Badge
                      variant="outline"
                      className="text-blue-600 border-blue-600 text-xs hover:bg-blue-50 transition-colors cursor-pointer"
                    >
      ...
      <section className="bg-gradient-to-r from-green-50 to-blue-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-4">
            Choose Your Berry Investment Plan
          </h2>
          <p className="text-center text-gray-600 mb-8 lg:mb-12 text-base lg:text-lg px-4">
            Both plans include complete setup, management, and very good returns
          </p>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                  <div>
                    ...
                    <CardDescription className="text-sm sm:text-base">
                      Grow on your own land • 90 plants/month
                    </CardDescription>
                  </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg">
                  ...
                  <div className="text-sm text-green-700">
                    <strong>Annual Plants:</strong> 1,080 plants
                    <br />
                    <strong>Your Investment:</strong> ₹36 lakhs/year
                    <br />
                ...
                <div className="mt-4 space-y-3">
                  ...
                  >
                    {loading
                      ? "Setting up..."
                      : `Start Daily SIP - ₹${
                          subscriptionTier === "1year" ? "9,999" : "18,999"
                        } (Cashfree UPI)`}
                  </button>
                  <div className="text-xs text-gray-500 text-center">
                    Secure payment via Cashfree • UPI Subscription • Cancel
                    anytime
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                  <div>
                    <CardTitle className="text-xl sm:text-2xl text-blue-600">
                      Land + Blueberry Package
                    </CardTitle>
                    <CardDescription className="text-sm sm:text-base">
                      We provide land • Ambari location
                    </CardDescription>
                  </div>
                  <Badge
                    variant="outline"
                    className="border-blue-500 text-blue-600 self-start"
                  >
                    LAND INCLUDED
                  </Badge>
                </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  <div className="text-sm text-blue-700">
                    <strong>Location:</strong> Ambari, T-state land
                    <br />
                    <strong>Minimum:</strong> 0.5 acre (₹65 lakhs)
                    <br />
                    <strong>Payment:</strong> Lumpsum investment
                    <br />
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">
            Your Blueberry Production Journey
          </h2>
          <div className="max-w-4xl mx-auto">
            <Card className="border-2 border-green-200">
              <CardHeader>
                <CardTitle>
                  Monthly Production Growth (90 plants/month)
                </CardTitle>
                <CardDescription>
                  See how your investment grows over 5 years
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {productionData.map((item, index) => (
                    <div
                      key={index}
                      className="text-center p-3 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg"
                    >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
              Ready to Start Your Berry Empire?
            </h2>
            <p className="text-lg lg:text-xl text-gray-600 mb-6 px-4">
              Join thousands of investors earning passive tax-free income
              through blueberry farming
            </p>
          </div>

          <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg mb-8">
            <h3 className="text-xl font-semibold mb-6 text-center">
              Get Started - Fill Your Details
            </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {selectedPlan === "dailySIP" && (
                ...
                >
                  {loading
                    ? "Setting up..."
                    : "Start Cashfree UPI Subscription"}
                </Button>
              )}
            </div>

            <p className="text-gray-500 mt-4 text-sm text-center">
              💬 Get instant responses • 📍 Location analysis • 💰 Investment
              guidance • 🔒 Secure payments
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-green-600 to-blue-600 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Get Your FREE Berry Farm Consultation
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Speak with our Darjberry experts via WhatsApp. Get personalized
            advice on land suitability, investment planning, and expected
            returns. No pressure, just pure berry wisdom! 🫐
          </p>
...
Please guide me through the next steps.`;
              ...
              const encodedMessage = encodeURIComponent(message);
              window.open(
                `https://wa.me/917047474942?text=${encodedMessage}`,
                "_blank"
              );
            }}
            size="lg"
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4 text-green-400">
            🫐 Grow berries on your land or in the Himalayas, earn passive
            tax-free income 🫐
          </h3>
          <p className="text-gray-300 mb-4">
            Be part of India's Amul for Berries • We take care of setup,
            growing, selling • Capital protected business
          </p>
